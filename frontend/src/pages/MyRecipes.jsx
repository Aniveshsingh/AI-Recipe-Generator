  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        {/* Title */}
        <h3 className="text-white font-semibold text-sm mb-2 line-clamp-2 group-hover:text-emerald-500 transition">
          {recipe.name}
        </h3>
        ...
        {/* Open Recipe */}
        <div className="flex items-center gap-1.5 text-xs text-gray-500 group-hover:text-emerald-400 transition pt-3 border-t border-white/5">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-5 mb-8">
          <div className="">
            <h1 className="text-3xl font-bold text-white flex items-center gap-2">
              ...
              My <span className="text-emerald-500"> Recipes</span>
            </h1>
          ...
          <div className="flex flex-wrap items-center gap-2">
            {selectMode ? (
              ...
              <>
                ...
                <button
                  onClick={() => navigate("/recipes/create?from=recipes")}
